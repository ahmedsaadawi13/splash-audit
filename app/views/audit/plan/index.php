<div class="page-header">
    <h2>Audit Plans</h2>
    <a href="<?php echo BASE_PATH; ?>/audit/plan/create" class="btn btn-primary">+ Create Plan</a>
</div>
        ...
        <tbody>
            <?php if (!empty($plans)): foreach ($plans as $plan): ?>
                <tr>
                    ...
                    <td><a href="<?php echo BASE_PATH; ?>/audit/plan/view/<?php echo $plan['id']; ?>" class="btn btn-sm">View</a></td>
                </tr>
            <?php endforeach; else: ?>
