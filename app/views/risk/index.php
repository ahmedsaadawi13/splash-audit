<div class="page-header">
    <h2>Risk Register</h2>
    <a href="<?php echo BASE_PATH; ?>/risk/create" class="btn btn-primary">+ Add Risk</a>
    <a href="<?php echo BASE_PATH; ?>/risk/heatmap" class="btn">View Heatmap</a>
</div>
        ...
        <tbody>
            <?php if (!empty($risks)): foreach ($risks as $risk): ?>
                <tr>
                    ...
                    <td><a href="<?php echo BASE_PATH; ?>/risk/edit/<?php echo $risk['id']; ?>" class="btn btn-sm">Edit</a></td>
                </tr>
            <?php endforeach; else: ?>
